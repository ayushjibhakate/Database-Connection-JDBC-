<nav class="navbar">
	...
	<div class="nav-links">
		<a href="#" class="active">Home</a> <a href="#">Our Home Models</a> <a
			href="#">Who We Are</a> <a href="#">What We Do & Why</a> <a href="#">FAQs</a>
	</div>

	
	<button class="contact-btn" onclick="window.location.href='Contact.jsp';">Contact us</button>
...
<main class="hero">
	<div class="hero-content">
		<h1>
			We Design Spaces That Inspire and Impress <span class="thumbnail">
				<img
				src="https://housely.com/wp-content/uploads/2016/09/Luxurious-yellow-themed-bedroom.jpg"
				alt="Modern interior thumbnail">
			</span>
		</h1>
		<div class="cta-container">
			<button class="booking-btn" onclick="location.href='bookmetting.jsp'">Booking a consultant</button>
		</div>
	</div>
...
<section class="difference-section">
	<div class="features-header">
		<span class="features-label">WHAT IS DIFFERENT</span>
		<h2 class="features-title">
			<span class="decorative-dash">~</span> What makes us different <span
				class="decorative-dash">~</span>
		</h2>
	</div>
		...
		<div class="carousel-track">
			<div class="carousel-item">
				...
				<div class="description">
					...
					<p>The other hand we denounce with righteous indignation and
						dislike beguiled pleasure...</p>
				</div>
			...
			<div class="carousel-item">
				...
				<div class="description">
					...
					<p>The joys of our design simplify your life with a touch of
						beauty...</p>
				</div>
			...
			<div class="carousel-item">
				...
				<div class="description">
					...
					<p>We combine creativity with practicality to deliver unique
						results...</p>
				</div>
				<div class="circle yellow">
					<svg viewBox="0 0 24 24" class="icon">
...
<section class="constr-services">
	<div class="features-header">
		<span class="features-label">NEED TO KNOW</span>
		<h2 class="features-title">
			<span class="decorative-dash">~</span> Our Services <span
				class="decorative-dash">~</span>
		</h2>
	</div>
	...
	<div class="constr-grid">
		<div class="constr-card">
			...
			<div class="constr-content">
				...
				<p>General contracting refers to a construction a single
					contractor.</p>
			</div>
		</div>
...
<section>
	<div class="features-header">
		<span class="features-label">SEE</span>
		<h2 class="features-title">
			<span class="decorative-dash">~</span> Our Projects <span
				class="decorative-dash">~</span>
		</h2>
	</div>
			...
			<div class="hero-slide active">
				...
				<div class="three">
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
					...
					<div class="oneImg twoImg threeImg"></div>
				</div>
			</div>
...
<section class="info-section">
	...
	<div class="info-stats">
		<div class="stat">
			<h3 class="stat-number" data-target="230">06</h3>
			<p>Complete projects</p>
		</div>
		<div class="stat">
			<h3 class="stat-number" data-target="24">16</h3>
			<p>Locations</p>
		</div>
		<div class="stat">
			<h3 class="stat-number" data-target="500">06</h3>
			<p>Satisfied clients</p>
		</div>
	</div>
</section>
<footer class="footer"> Made by Ayush </footer>


<!-- External CSS -->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/home_design.css">
